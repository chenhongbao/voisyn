...
public class Wave {
     ...
     *
     * @param format AudioFormat of the wave file.
     ...
     *
     * @param seconds The number of seconds of recording.
     * @return The number of bytes recorded.
     * @throws Exception the string in Exception will indicate the cause of error.
     */
     ...
     *
     * @param wave Wave instance to be appended.
     * @return The reference to the calling Wave class.
     * @throws Exception When the calling Wave instance cannot be written to, it will
     *                   throw the exception.
     */
     ...
     * @throws Exception It will throw exceptions at the IO error.
     */
    ...
    public void Play() throws Exception {
        ...
        if (this.auline == null || this.auline.isOpen() == false) {
            ...
            try {
                if (abData.length > 0) {
                    this.auline.write(abData, 0, abData.length);
                }
            } catch (Exception e) {
                throw new Exception("Wave: Error on writing to SourceDataLine.");
            } finally {
                this.auline.drain();
                this.auline.close();
            }
            ...
            // If the audio line is open, just starts it.
            this.auline.start();
    ...
    /**
     * Pause the audio.
     * <p>Note that it stops the audio at the current position, and
